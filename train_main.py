...
flags.DEFINE_string('dataset_file_pattern', './flowers/*.*', 'Dataset file pattern.')
...
flags.DEFINE_integer('num_resolutions', 7, 'Number of progressive resolutions.')
#ok [64, 32, 16, 8, 4, 4, 4]
#no [128, 64, 32, 16, 8, 4, 4]
#no [128, 64, 32, 16, 4, 4, 4]
flags.DEFINE_list(
    'batch_size_schedule', [64, 32, 16, 8, 4, 4, 4],
...
flags.DEFINE_float('generator_learning_rate', 0.0001, 'Learning rate.')

flags.DEFINE_float('discriminator_learning_rate', 0.0001, 'Learning rate.')
...
flags.DEFINE_string('train_root_dir', './model',
